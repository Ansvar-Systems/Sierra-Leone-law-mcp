/**
 * Tool registry for Sierra Leone Law MCP Server.
...
import { getSierra LeoneanImplementations, type GetSierra LeoneanImplementationsInput } from './get-sierra leonean-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including Sierra Leone Law (National Council for Law Reporting). ' +
    ...
    'Call this FIRST when you need to understand what Sierra Leonean legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Sierra Leonean statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (article) from an Sierra Leonean proclamation or regulation. ' +
  ...
  },
  {
    ...
    description:
      'Validate an Sierra Leonean legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Sierra Leonean statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Sierra Leone?" ' +
  ...
  },
  {
    ...
    description:
      'Format a Sierra Leonean legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether an Sierra Leonean proclamation or provision is currently in force, amended, or repealed. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get the EU/international legal basis that a Sierra Leonean statute aligns with or references. ' +
      'Sierra Leone is not an EU member but several Sierra Leonean laws were influenced by EU regulations ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Sierra Leonean statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_sierra leonean_implementations',
    description:
      'Find all Sierra Leonean statutes that align with or implement a specific EU directive or regulation. ' +
      'Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns matching Sierra Leonean statutes. ' +
      'Note: Sierra Leone implements international standards through domestic legislation influenced by international frameworks.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that have Sierra Leonean implementing/aligning legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_sierra leonean_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents with Sierra Leonean aligning legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU/international legal basis for a SPECIFIC provision within a Sierra Leonean statute. ' +
  ...
  },
  {
    ...
    description:
      'Check EU/international alignment status for a Sierra Leonean statute or provision. ' +
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_sierra leonean_implementations':
          result = await getSierra LeoneanImplementations(db, args as unknown as GetSierra LeoneanImplementationsInput);
          break;
