...
export async function listSources(
  ...
  return {
    results: {
      sources: [
        {
          name: 'Sierra Leonean Legal Information Portal',
          authority: 'lawsierra leonean.com (Sierra Leonean Legal Information Portal)',
          url: 'https://www.lawsierra leonean.com',
          license: 'Government Open Data',
          coverage:
            'Federal proclamations, regulations, and directives published in the Federal Negarit Gazette. ' +
            'Includes the Constitution of Sierra Leone (1995), major legislative acts from 1995 to present, ' +
