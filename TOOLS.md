# Tools — Sierra Leone Law MCP

8 tools for searching and retrieving Sierra Leone legislation.

---

## 1. search_legislation

Full-text search across all Sierra Leone statutes and regulations.
