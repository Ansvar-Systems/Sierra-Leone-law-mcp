...
- **Professional Rules**: Law Society of Sierra Leone members must comply with applicable professional conduct rules when using AI tools
...
1. Checking the official source (Sierra Leone Law Reports (sierra leoneanlaw.org), Sierra Leone Gazette)
...
This Tool aggregates data from official Sierra Leone legal databases. However:
...
- Sierra Leone law changes continuously through new statutes, amendments, and court decisions
...
2. **Official Verification**: Cross-check ALL results with official sources (Sierra Leone Law Reports (sierra leoneanlaw.org), Sierra Leone Gazette)
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Sierra Leone-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Sierra Leone-law-mcp/issues
