#!/usr/bin/env tsx
/**
 * Database builder for Sierra Leone Law MCP server.
 *
...
function buildDatabase(): void {
  console.log('Building Sierra Leone Law MCP database...\n');
          ...
          if (extractedRefs.length > 0) {
            ...
            for (const ref of extractedRefs) {
              ...
              const euInsert = insertEuDocument.run(
                ...
                shortName, shortName, eurLexUrl, 'Auto-extracted from Sierra Leonean statute text',
              );
  ...
  const writeMeta = db.transaction(() => {
    ...
    insertMeta.run('source', 'lawsierra leonean.com');
