/**
 * Sierra Leone Law PDF Parser
 *
 * Parses text extracted from Sierra Leonean proclamation PDFs (Federal Negarit Gazette).
...
export function parseSierra LeoneLawHtml(html: string, act: ActIndexEntry): ParsedAct {
  return parsePdfText(html, act);
}
