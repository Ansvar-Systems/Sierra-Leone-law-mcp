#!/usr/bin/env tsx
/**
 * Sierra Leone Law MCP -- Census Script
 *
 * Enumerates ALL proclamations, regulations, and directives from lawsierra leonean.com.
...
const BASE_URL = 'https://www.lawsierra leonean.com';
...
const FEDERAL_CATEGORIES = [
  ...
  'banking-and-monetary-system/national-bank-of-sierra leonean',
  ...
  'parliament', 'police', 'president-of-sierra leonean', 'prison',
...
async function scrapeCategoryPage(categoryPath: string): Promise<RawLaw[]> {
  ...
  for (const link of links) {
    ...
    if (link.href.startsWith('http') && !link.href.includes('lawsierra leonean.com')) continue;
...
async function main(): Promise<void> {
  ...
  console.log('Sierra Leone Law MCP -- Census Script');
  console.log('=================================\n');
  ...
  console.log(`  Jurisdiction:   Sierra Leone (ET)`);
  console.log(`  Source:         ${BASE_URL}`);
