# Sierra Leone Law MCP Server — Developer Guide
...
Sierra Leone Law MCP server providing Sierra Leonean legislation search via Model Context Protocol. Strategy A deployment (Vercel, bundled SQLite DB). Covers data protection, cybercrimes, ICT, companies, consumer protection, and other key Acts.
...
- Sierra Leone uses "Section N" for Acts and "Article N" for the Constitution
...
1. `scripts/ingest.ts` -> fetches from Sierra Leone Law -> JSON seed files in `data/seed/`
...
- **Sierra Leone Law** (sierra leoneanlaw.org) -- National Council for Law Reporting
- **License:** Government Open Data
- **Languages:** English (en) is the primary legal language; Swahili (sw) for some documents
- **Coverage:** All Acts of Parliament, subsidiary legislation, Constitution of Sierra Leone 2010, selected case law

## Sierra Leone-Specific Notes

- Sierra Leone uses a common law legal system inherited from British colonial administration
- The Constitution of Sierra Leone 2010 is the supreme law (Article 2)
...
- For the Constitution: "Article N, Constitution of Sierra Leone 2010"
...
- npm package: `@ansvar/sierra leonean-law-mcp` with bin entry for stdio
